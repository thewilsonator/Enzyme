...
# Adapted from https://github.com/llvm/llvm-project/blob/main/llvm/utils/update_test_checks.py
...
Example usage:
$ update_test_checks.py --opt-binary=~/Developer/llvm-project/build/bin/opt --loadEnzyme=-load=/Users/tim/Developer/Enzyme/enzyme/build/Enzyme/LLVMEnzyme-12.dylib --loadClangEnzyme=-load=/Users/tim/Developer/Enzyme/enzyme/build/Enzyme/ClangEnzyme-12.dylib --llvmver=12  ../test/Enzyme/ForwardMode/add.ll
  ...
  for ti in common.itertests(initial_args.tests, parser,
    ...
    for prefixes, opt_args, preprocess_cmd in prefix_list:
      ...
      raw_tool_output = common.invoke_tool(ti.args.opt_binary, opt_args,
                                           ti.path, ti.args.loadEnzyme, ti.args.loadClangEnzyme, ti.args.llvmver, preprocess_cmd=preprocess_cmd,
