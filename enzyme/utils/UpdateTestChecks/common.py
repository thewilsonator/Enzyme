# Adapted from https://github.com/llvm/llvm-project/blob/main/llvm/utils/UpdateTestChecks/common.py
...
def parse_commandline_args(parser):
  ...
  parser.add_argument('--loadEnzyme', help='Path to LLVMEnzyme plugin', metavar='LLVMEnzyme', type=str, required=True)
  parser.add_argument('--loadClangEnzyme', help='Path to ClangEnzyme plugin', metavar='ClangEnzyme', type=str, required=True)
  parser.add_argument('--llvmver', help='LLVM version', metavar='LLVM_VERSION', type=str, required=True)
...
def getSubstitutions(sourcepath, loadEnzyme, loadClangEnzyme, llvmver):
  ...
  return [('%s', sourcepath),
          ...
          ('%loadClangEnzyme', loadClangEnzyme),
          ('%llvmver', llvmver),
          ]
...
def invoke_tool(exe, cmd_args, ir, loadEnzyme, loadClangEnzyme, llvmver, preprocess_cmd=None, verbose=False):
  with open(ir) as ir_file:
    substitutions = getSubstitutions(ir, loadEnzyme, loadClangEnzyme, llvmver)
