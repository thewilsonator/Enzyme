...
define dso_local void @_Z7dsquared(%"struct.std::array.vec"* noalias sret(%"struct.std::array.vec") align 8 %agg.result, double %x) local_unnamed_addr #1 {
entry:
  %0 = load i32, i32* @enzyme_width, align 4
  call void (%"struct.std::array.vec"*, i8*, ...) @_Z16__enzyme_fwddiffPvz(%"struct.std::array.vec"* sret(%"struct.std::array.vec") align 8 %agg.result, i8* bitcast (void (%"struct.std::array"*, double)* @_Z6squared to i8*), i32 %0, i32 3, double %x, <3 x double> <double 1.000000e+00, double 2.000000e+00, double 3.000000e+00>)
  ret void
}

declare dso_local void @_Z16__enzyme_fwddiffPvz(%"struct.std::array.vec"* sret(%"struct.std::array.vec") align 8, i8*, ...) local_unnamed_addr #2
...
entry:
  ...
  call void @_Z7dsquared(%"struct.std::array.vec"* nonnull sret(%"struct.std::array.vec") align 8 %ref.tmp, double 3.000000e+00)
  %dx1 = getelementptr inbounds %"struct.std::array.vec", %"struct.std::array.vec"* %ref.tmp, i64 0
